        ...
        item.product.name
                ...
                <div class="cart-item-details">
                    ...
                    <button class="btn btn-danger btn-sm mt-2" 
                            onclick="cartManager.removeFromCart(${
                              item.product.id
                            })">
                        Remove
                    </button>
      ...
      productCard.innerHTML = `
        ...
        product.name
                ...
                <div class="card-body">
                    ...
                    <button onclick="cartManager.addToCart({ id: ${
                      product.id
  ...
  if (promotionsList) {
    promotions.forEach((promo) => {
      ...
      promoElement.innerHTML = `
                <div class="card">
                    <img src="${promo.imageUrl}" class="card-img-top" alt="${
        promo.name
      }">
                    <div class="card-body">
                        <h5 class="card-title">${promo.name}</h5>
                        <p class="card-text">${promo.description}</p>
                        <p class="text-danger"><del>$${promo.originalPrice.toFixed(
                          2
                        )}</del> <strong>$${promo.discountedPrice.toFixed(
        2
      )}</strong></p>
                        <button class="btn btn-primary" onclick="cartManager.addToCart({ id: ${
                          promo.id
                        }, name: '${promo.name}', price: ${
        promo.discountedPrice
      }, imageUrl: '${promo.imageUrl}' })">Add to Cart</button>
                    </div>
                </div>
            `;
